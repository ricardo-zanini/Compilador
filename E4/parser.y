...
bloco_comandos_conteudo_lista
    : comando_simples                               { $$ = $1; }
    | comando_simples bloco_comandos_conteudo_lista { if ($1) { if ($2) asd_add_child($1, $2); $$ = $1; } else { $$ = $2; } }
...
repeticao
    : TK_ENQUANTO '(' expressao ')' bloco_comandos { $$ = criar_no_unario("enquanto", $3->data_type, $3); if ($5) asd_add_child($$, $5); } /* label é o lexema de TK_ENQUANTO */
;
